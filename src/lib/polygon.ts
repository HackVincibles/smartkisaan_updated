...
export class PolygonService {
  ...
  // --- ESCROW LOGIC ---
  async confirmDeliveryOnChain(orderId: string, aiScore: number, imageCID: string) {
    try {
  ...
  // --- REPUTATION LOGIC (Soulbound Tokens) ---
  async awardFarmerBadge(farmerAddress: string, badgeName: string, ipfsUri: string) {
    try {
